...
fun SegmentTimeAdjustment.toEntity(): SegmentTimeAdjustmentEntity {
    return SegmentTimeAdjustmentEntity(
        ...
        averageActualDurationMinutes = averageActualDurationMinutes,
        minActualDurationMinutes = minActualDurationMinutes,
        maxActualDurationMinutes = maxActualDurationMinutes,
