...
- T-30/T-15/T-10/T-5 재조회 결과로 권장 출발 시각이 바뀌면 같은 루틴의 상태 알림을 갱신합니다.
...
- 경로 길이에 따라 재조회 시점이 달라집니다.
  - 일반 경로: 출발 `60, 30, 15, 10, 5`분 전
  - 60분 이상 경로: 출발 `90, 60, 30, 15, 10, 5`분 전
  - 90분 이상 경로: 출발 `120, 90, 60, 30, 15, 10, 5`분 전
